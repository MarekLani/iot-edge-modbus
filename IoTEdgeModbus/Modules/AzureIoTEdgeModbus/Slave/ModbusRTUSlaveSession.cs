namespace AzureIoTEdgeModbus.Slave
{
    ...
    public class ModbusRTUSlaveSession : ModbusSlaveSession
    {
        ...
        protected override void EncodeWrite(byte[] request, WriteOperation operation)
        {
            //uid
            request[0] = Convert.ToByte(operation.UnitId);

            //Body
            //function code
            request[m_dataBodyOffset] = operation.FunctionCode;
            ...
            //value
            UInt16 value_int = (UInt16)Convert.ToInt32(operation.Value);
            if (operation.Entity == '0' && value_int == 1)
            {
